...
namespace ys
{
	...
	{
		auto an = GetOwner()->GetComponent<Animator>();
		if (an->GetActive()->getName() == L"플레이어_기본총_우공격_점프_화염" || an->GetActive()->getName() == L"플레이어_기본총_좌공격_점프_화염")
		{
			if (direction == Vector2::Right)
			{
				an->PlayAnimation(L"플레이어_기본총_우공격_점프", false);
			}
			else
			{
				an->PlayAnimation(L"플레이어_기본총_좌공격_점프", false);
			}
			return;
		}
		if (an->GetActive()->getName() == L"플레이어_기본총_우공격_화염" || an->GetActive()->getName() == L"플레이어_기본총_좌공격_화염")
		{
			if (direction == Vector2::Right)
			{
				an->PlayAnimation(L"플레이어_기본총_우공격", false);
			}
			else
			{
				an->PlayAnimation(L"플레이어_기본총_좌공격", false);
			}
			return;
		}
		if (an->GetActive()->getName() == L"플레이어_기본총_우공격" || an->GetActive()->getName() == L"플레이어_기본총_좌공격"
			|| an->GetActive()->getName() == L"플레이어_기본총_우공격_점프"|| an->GetActive()->getName() == L"플레이어_기본총_좌공격_점프")
		{
	...
	void PlayerScript::idle()
	{
		...
		if (InputManager::getKeyDown(VK_SPACE))
		{
			if (direction == Vector2::Right)
			{
				an->PlayAnimation(L"플레이어_기본총_우공격_화염", false);
			}
			else {
				an->PlayAnimation(L"플레이어_기본총_좌공격_화염", false);
			}
