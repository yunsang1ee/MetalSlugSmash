...
namespace ys
{
	void LoadResources()
	{
		...
		{
			//무기
			Resources::Load<graphics::Texture>(L"총알png", L"..\\Resource\\기본총알.png");
			Resources::Load<graphics::Texture>(L"수류탄", L"..\\Resource\\수류탄.bmp");

			//폭발
			Resources::Load<graphics::Texture>(L"수류탄폭발", L"..\\Resource\\수류탄폭발.bmp");
		...
		tmp->SetGroup(enums::AudioGroup::BackGorund);
		tmp = Resources::Load<AudioClip>(L"발사사운드", L"..\\Resource\\gun_sound.wav");
		tmp->SetGroup(enums::AudioGroup::Effect);
	}
}